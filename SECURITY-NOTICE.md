...
This repository does **not** use those affected PyPI releases by default. The stack pulls a prebuilt LiteLLM container image pinned by digest in `compose.yaml`. If you override that pin or install LiteLLM separately, verify package provenance carefully and avoid the affected releases.
